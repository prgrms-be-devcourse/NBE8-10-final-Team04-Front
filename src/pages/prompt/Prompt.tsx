...
export default function Prompt() {
  const {searchQuery, setSearchQuery, activeCategory, setActiveCategory, filteredPrompts, categories} = usePrompts();
    ...
    >
      <div className="flex flex-col gap-8">
        ...
        <div className="text-sm font-medium text-slate-500">
          총 <span className="font-bold text-primary">{filteredPrompts.length}</span>개의 프롬프트가 있습니다.
        </div>
